import os
Estimation_outdir = '/path/to/NO2_DL_global/Training_Evaluation_Estimation/'

# Dataset dir holding obs/training for the map-side uncertainty. Env-overridable so a
# v7.2 run points at Global_NO2_v7 without disturbing the v6 default.
version               = os.environ.get('MAHAL_DATASET_VERSION', 'Global_NO2_v6')
TrainingData_outdir = f'/path/to/NO2_DL_global/TrainingDatasets/{version}/'
...
Observation_indir                   = f'/path/to/NO2_DL_global/TrainingDatasets/{version}/'

ML_NO2_input_indir                  = '/path/to/NO2_DL_global/input_variables/ML_input/'

GeoNO2_input_indir                  = '/path/to/NO2_DL_global/input_variables/GeoNO2-v5.13_input/'
GeoNO2v513_downscaled_input_indir   = '/path/to/NO2_DL_global/input_variables/GeoNO2-v5.13_downscaled/'
GCHP_input_dir                      = '/path/to/NO2_DL_global/input_variables/GCHP_input/'
Meteorology_input_indir             = '/path/to/NO2_DL_global/input_variables/Meteorology_input/'
HTAPv3_Emissions_input_indir        = '/path/to/NO2_DL_global/input_variables/HTAPv3_Anthropogenic_Emissions_input/'

CEDS_Emissions_input_indir          = '/path/to/NO2_DL_global/input_variables/CEDS_Anthro_Emissions_01_input/'
LandCover_input_indir               = '/path/to/NO2_DL_global/input_variables/LandCover_input/'
Geographical_Variables_input_indir  = '/path/to/NO2_DL_global/input_variables/Geographical_Variables_input/'
GFED4_input_indir                   = '/path/to/NO2_DL_global/input_variables/GFED4_Emissions_input/'
Population_input_indir              = '/path/to/NO2_DL_global/input_variables/Population_input/'
OpenStreetMap_nearest_dist_indir    = '/path/to/NO2_DL_global/input_variables/OpenStreetMap_RoadDensity_NearestDistances_forEachPixels_input/'
OpenStreetMap_road_density_indir    = '/path/to/NO2_DL_global/input_variables/OpenStreetMap_RoadDensity_input/'
OpenStreetMap_buffer_indir          = '/path/to/NO2_DL_global/input_variables/OpenStreetMap_RoadDensity_Buffer_forEachPixels_input/'
NDVI_input_indir                    = '/path/to/NO2_DL_global/input_variables/NDVI_input/'
ISA_input_indir                     = '/path/to/NO2_DL_global/input_variables/ISA_input/'
LandCover_Density_input_indir       = '/path/to/NO2_DL_global/input_variables/LandCover_input/'
LandCover_Distance_input_indir      = '/path/to/NO2_DL_global/input_variables/LandCover_NearestDistances_forEachPixels_input/'
LandCover_Buffer_input_indir        = '/path/to/NO2_DL_global/input_variables/LandCover_buffer_forEachPixels_input/'

def inputfiles_table(YYYY, MM):
    # 'GeoNO2-v2': DOWNSCALED GeoNO2 (R_fine x boxcar10) for the OMI era
    # 2005-01..2018-05; native 1 km v5.13 GeoNO2 for the TROPOMI era 2018-06..2023.
    # Same era cutover as the training/estimation inputfiles_table maps.
    _geono2v2_is_omi = (int(YYYY) < 2018) or (int(YYYY) == 2018 and int(MM) <= 5)
    _GeoNO2v2_indir  = GeoNO2v513_downscaled_input_indir if _geono2v2_is_omi else GeoNO2_input_indir
    inputfiles_dic = {
        'GeoNO2-v2'          : _GeoNO2v2_indir + '{}/GeoNO2_trop_GC_001x001_Global_map_{}{}.npy'.format(YYYY,YYYY,MM),
        ##################### [Variables from ML_NO2] ###################
        'ML_NO2_2019_Map'             : ML_NO2_input_indir + '2019/ML_NO2_Map_001x001_Global_map_2019{}.npy'.format(MM),
        'ML_NO2_2019_FSU'             : ML_NO2_input_indir + '2019/ML_NO2_FSU_001x001_Global_map_2019{}.npy'.format(MM),
        #####################[Variables from Geophysical Species] ###################
        'GeoNO2'             : GeoNO2_input_indir + '{}/GeoNO2_trop_GC_001x001_Global_map_{}{}.npy'.format(YYYY,YYYY,MM),
